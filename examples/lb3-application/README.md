...
it mounted on with command `npm tests`.
...
1. When launch the LoopBack 4 Express server

- 1.1 Update to use the LB4 Express server when doing requests:
...
- 1.2 Boot and start the LB4 app in your before hook, and stop the app in the
  after hook:
...
- 2.1 Update to use the LB4 Express server when doing requests:
...
- 2.2 Boot and start the LB4 app in your before hook, and stop the app in the
  after hook:
